...
init_ocHnNetConfig(void)
{
  ...
  DEBUGMSGTL(("ocHnNetConfig", "Initializing\n"));
    ...
    netsnmp_register_scalar(
        netsnmp_create_handler_registration("ocHnNetConfigViewPrimaryOutputPort", handle_ocHnNetConfigViewPrimaryOutputPort,
...
int
handle_ocHnNetConfigViewPrimaryOutputPort(netsnmp_mib_handler *handler,
