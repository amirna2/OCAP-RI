...
{
    static oid ocStbHostAVInterfaceTable_oid[] = {1,3,6,1,4,1,4491,2,3,1,1,1,2,2};
    size_t ocStbHostAVInterfaceTable_oid_len = OID_LENGTH(ocStbHostAVInterfaceTable_oid);
    netsnmp_table_data_set *table_set;

    /* create the table structure itself */
    table_set = netsnmp_create_table_data_set("ocStbHostAVInterfaceTable");
    ...
    DEBUGMSGTL(("initialize_table_ocStbHostAVInterfaceTable",
                "adding indexes to table ocStbHostAVInterfaceTable\n"));
    netsnmp_table_set_add_indexes(table_set,
                           ASN_UNSIGNED,  /* index: ocStbHostAVInterfaceIndex */
                           0);

    DEBUGMSGTL(("initialize_table_ocStbHostAVInterfaceTable",
                "adding column types to table ocStbHostAVInterfaceTable\n"));		 
    netsnmp_table_set_multi_add_default_row(table_set,
                                            COLUMN_OCSTBHOSTAVINTERFACEINDEX, ASN_UNSIGNED, 0,
                                            NULL, 0,
                                            COLUMN_OCSTBHOSTAVINTERFACETYPE, ASN_OBJECT_ID, 0,
                                            NULL, 0,
                                            COLUMN_OCSTBHOSTAVINTERFACEDESC, ASN_OCTET_STR, 0,
                                            NULL, 0,
    ...
    netsnmp_register_table_data_set(netsnmp_create_handler_registration("ocStbHostAVInterfaceTable", ocStbHostAVInterfaceTable_handler,
