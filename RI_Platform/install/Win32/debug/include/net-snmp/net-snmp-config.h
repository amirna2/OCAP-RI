...
#define NETSNMP_CONFIGURE_OPTIONS " 'CC=gcc-3 -mno-cygwin' 'CXX=g++-3 -mno-cygwin' '--build=i686-pc-cygwin' '--host=i686-pc-mingw32' '--prefix=/cygdrive/c/OCAPRI/trunk/ri/RI_Platform/install/Win32/debug' '--enable-option-checking' '--disable-as-needed' '--enable-agent' '--disable-applications' '--disable-manuals' '--disable-scripts' '--disable-mibs' '--disable-mib-config-checking' '--disable-mib-config-debug' '--disable-new-features' '--disable-old-features' '--disable-ucd-snmp-compatibility' '--disable-mib-loading' '--enable-des' '--enable-privacy' '--enable-internal-md5' '--enable-ipv6' '--disable-snmpv1' '--enable-snmpv2c' '--enable-debugging' '--enable-developer' '--disable-testing-code' '--disable-reentrant' '--disable-deprecated' '--enable-set-support' '--disable-local-smux' '--enable-snmptrapd-subagent' '--enable-mini-agent' '--disable-mfd-rewrites' '--disable-embedded-perl' '--disable-perl-cc-checks' '--enable-shared' '--disable-static' '--enable-fast-install' '--disable-libtool-lock' '--without-rpm' '--without-defaults' '--without-opaque-special-types' '--with-logfile=C:/OCAPRI/trunk/common/snmp/netsnmpd.log' '--with-persistent-directory=C:/OCAPRI/trunk/common/snmp' '--with-copy-persistent-files=no' '--with-default-snmp-version=2' '--with-transports=UDP TCP UDPIPv6 TCPIPv6' '--with-out-transports=DTLSUDP TLSTCP SSH' '--without-root-access' '--without-kmem-usage' '--without-dummy-values' '--with-sys-contact=ocapri@cablelabs.com' '--with-sys-location=louisville, co' '--with-mib-modules=agentx agent_mibs notification examples/example' '--with-out-mib-modules=snmpv3mibs host/hr_network' '--without-perl-modules' '--without-python-modules' '--without-elf' '--without-nl' '--without-libwrap' '--without-zlib' '--without-bzip2' '--without-mysql' '--with-openssl=internal' 'build_alias=i686-pc-cygwin' 'host_alias=i686-pc-mingw32'"

/* default location to look for mibs to load using the above tokens and/or
   those in the MIBS envrionment variable */
#define NETSNMP_DEFAULT_MIBDIRS "$HOME/.snmp/mibs;/cygdrive/c/OCAPRI/trunk/ri/RI_Platform/install/Win32/debug/share/snmp/mibs"
...
#define PACKAGE_STRING "Net-SNMP 5.6.1"
#endif
...
#define SIZEOF_SOCKADDR_UN_SUN_PATH 0
...
#define NETSNMP_DEFAULT_MIBS ";NET-SNMP-AGENT-MIB;SNMPv2-MIB;IF-MIB;IP-MIB;TCP-MIB;UDP-MIB;NET-SNMP-VACM-MIB;SNMP-NOTIFICATION-MIB;SNMP-VIEW-BASED-ACM-MIB;SNMP-COMMUNITY-MIB;SNMP-TARGET-MIB;SNMPv2-TM"
...
#define NETSNMP_PERSISTENT_DIRECTORY "C:/OCAPRI/trunk/common/snmp"
...
#define NETSNMP_SYSTEM_INCLUDE_FILE "net-snmp/system/mingw32.h"
...
#define SNMPLIBPATH "/cygdrive/c/OCAPRI/trunk/ri/RI_Platform/install/Win32/debug/lib/snmp"
#define SNMPSHAREPATH "/cygdrive/c/OCAPRI/trunk/ri/RI_Platform/install/Win32/debug/share/snmp"
#define SNMPCONFPATH "/cygdrive/c/OCAPRI/trunk/ri/RI_Platform/install/Win32/debug/etc/snmp"
#define SNMPDLMODPATH "/cygdrive/c/OCAPRI/trunk/ri/RI_Platform/install/Win32/debug/lib/snmp/dlmod"
...
#define NETSNMP_LOGFILE "C:/OCAPRI/trunk/common/snmp/netsnmpd.log"

/* default system contact */
#define NETSNMP_SYS_CONTACT "ocapri@cablelabs.com"

/* system location */
#define NETSNMP_SYS_LOC "louisville, co"
