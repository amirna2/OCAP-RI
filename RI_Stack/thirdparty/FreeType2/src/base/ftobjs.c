...
FT_EXPORT_DEF( void ) FT_Set_Hint_Flags( FT_Face face, FT_ULong flags );
...
#define FT_COMPONENT  trace_objs
  ...
  Load_Ok:
    ...
    if ( ( load_flags & FT_LOAD_LINEAR_DESIGN ) == 0 )
    {
	  ...
	  /* this new function rounds up instead of to the nearest per MHP 1.1.3 */
      slot->linearHoriAdvance = FT_MulDiv_MHP( slot->linearHoriAdvance,
