 ...
 */
static DFBResult
IDirectFBFont_GetFamilyName( IDirectFBFont *thiz, char **family )
{
     INTERFACE_GET_DATA(IDirectFBFont)
...
static DFBResult IDirectFBFont_GetStyleFlags( IDirectFBFont *thiz, DFBFontStyle *style )
{
     INTERFACE_GET_DATA(IDirectFBFont)
...
IDirectFBFont_Construct( IDirectFBFont *thiz, CoreFont *font )
{
     ...
     thiz->GetFamilyName = IDirectFBFont_GetFamilyName;
     thiz->GetStyleFlags = IDirectFBFont_GetStyleFlags;
