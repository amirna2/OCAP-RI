 ...
 */
typedef struct {
     const char *filename;      // If creating via a filename (otherwise set to NULL)
     const char *fontbuffer;    // If creating via a pre-loaded font buffer (otherwise set to NULL)
     int fontsize;              // Only used if fontbuffer specified
