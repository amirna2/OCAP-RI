...
#define DFB_MIN(a,b) ((a) < (b) ? (a) : (b))
#define DFB_MAX(a,b) ((a) > (b) ? (a) : (b))
#define DFB_SIGN(x)  ((x<0) ?  -1  :  ((x>0) ? 1 : 0))
#define DFB_ABS(x)   ((x) > 0 ? (x) : -(x))
...
/*
 ...
 but uses some IEEE specific tricks for better speed.
*/
int DFB_ICEIL(float f); // This function has been moved to util.c
