   ...
   implements IXMLParser
{
   ...
   public StdXMLParser()
   {
    ...
    /*===================================================================
     * !!!!!MODIFIED CODE!!!!!
     * Finalizer method removed 
     * by Aaron Kamienski (Vidiom Systems Corp). 
     * 2005/05/20
     * Removed because it is completely unnecessary.
     * In some cases where there are finalizers they don't guard against
     * NullPointerExceptions properly.
     * =================================================================*/
   /**
      ...
      throws Exception
   {
      ...
      if (false && // don't read external DTD at all...
          systemID != null) {
