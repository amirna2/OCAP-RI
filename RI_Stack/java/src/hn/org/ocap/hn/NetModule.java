 ...
 * <code>Device</code>. It is a group of related actions. A NetModule is always
 * associated with a homenetwork <code>Device</code>. Application may monitor a
 * NetModule's status by subscribing as a listener to this NetModule.
 */
public interface NetModule
{
     ...
     * 
     * @return An enumeration of String object representing property keys for
     *         this NetModule
     */
    ...
    /**
     * Returns the type of this NetModule. The allowed types are defined as
     * constant field in <code>NetModule</code>, for example, CONTENT_MANAGER,
     * CONTENT_LIST.
     * 
    ...
    /**
     * Returns the id of this NetModule, which is unique within the device. An
     * example could be, ContentListing1.
     * 
    ...
    /**
     * Adds a NetModuleEventListener instance to this NetModule. If the listener
     * passed in is already registered with this NetModule, this method does
     * nothing.
     * 
     * @param listener
     *            a NetModuleEventListener instance to be notified of
     *            NetModuleEvents.
     */
    void addNetModuleEventListener(NetModuleEventListener listener);

    /**
     * Removes a NetModuleEventListener instance from this NetModule. If the
     * specified instance is not registered with this NetModule, this method
     * does nothing.
     * 
     * @param listener
     *            a NetModuleEventListener instance to be removed from this
     *            NetModule.
     */
     ...
     * 
     * @return true if this NetModule is hosted on the local device, false
     *         otherwise.
     */
