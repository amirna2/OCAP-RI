...
/**
 * A list comprising of homenetwork elements such as Device or NetModule. The
 * application may retrieve such a list from <code>NetManager</code>,
 * <code>getNetModules</code> * or <code> getDevices</code>. The application may
 * refine the list by applying a {@link PropertyFilter}.
 */
public interface NetList
{
    ...
    /**
     * Returns all elements in this NetList in <code>Enumeration</code>. In
     * Homenetwork, NetList can be used to retrieve a list of Devices or a list
     * of NetModules. In either case, a corresponding type of object is
     * returned.
     * 
