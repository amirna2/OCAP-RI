...
public final class LogSF extends LogXF {
     ...
     * @param argument a value to be formatted and substituted.
     */
    public static void debug(final Logger logger, final String pattern, Throwable t, 
        final Object argument) {
        if (logger.isDebugEnabled()) {
            forcedLog(logger, Level.DEBUG, format(pattern, argument), t);
        }
    }
    ...
    public static void info(final Logger logger, final String pattern,
        ...
        if (logger.isInfoEnabled()) {
            forcedLog(logger, Level.INFO, format(pattern, argument), t);
        }
    }
    ...
    public static void warn(final Logger logger, final String pattern,
        final Object argument, Throwable t) {
        if (logger.isEnabledFor(Level.WARN)) {
            forcedLog(logger, Level.WARN, format(pattern, argument), t);
        }
    }
