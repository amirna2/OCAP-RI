...
public class Category implements AppenderAttachable {
  ...
  */
  ...
  void forcedLog(String fqcn, Level level, Object message, Throwable t) {
      ...
      {
          callAppenders(new LoggingEvent(FQCN, this, System.currentTimeMillis(), level, message, null, (t == null ? null : new ThrowableInformation(t, this)), null, null, groupMap));
      }
  }
