/* X509Certificate.java -- X.509 certificate.
   ...
   Copyright (C) 2004  Casey Marshall <csm@metastatic.org>
  ...
  implements Serializable, GnuPKIExtension
{
  ...
  //TODO: find system.outs and wrap around if debug checks
  private static final boolean DEBUG = false;
  private static void debug(String msg)
  {
    if (DEBUG)
      {
        System.err.print(">> X509CertificateImpl: ");
...
// X509Extension methods.
  ...
  public boolean equals(Object other)
  {
    ...
    try
      {
        if (other instanceof X509CertificateImpl)
          return Arrays.equals(encoded, ((X509CertificateImpl) other).encoded);
