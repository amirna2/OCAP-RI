...
class RecordInput
{
    ...
    throws IOException
  {
      ...
      {
          debug.println ("read - buf len: " + buf.length + ", offset: " + off + ", num bytes to read: " + len + ", content type: " + type +", input: " + in);
      }
  ...
  private void readRecord() throws IOException
  {
      ...
      if (DEBUG_RECORD_LAYER)
      {
          debug.println ("readRecord start");
      }
    ...
    if (DEBUG_RECORD_LAYER)
      {
        ...
        //TODO: RI - added
        debug.print ("fragment: " + Util.hexDump (fragment, "  "));
