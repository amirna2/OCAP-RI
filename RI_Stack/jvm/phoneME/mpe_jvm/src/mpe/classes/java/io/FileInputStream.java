...
public class FileInputStream extends InputStream
{
    ...
    public FileInputStream(FileDescriptor fdObj)
    {
        ...
        if (security != null)
        {
            if (fdObj.getPath() == null)
                security.checkRead(fdObj);
            else
                security.checkRead(fdObj.getPath());
        }
        fd = new FileDescriptor(fdObj);
    }
     ...
     */
    /*
     * Comment out due to no NIO in CDC public FileChannel getChannel() {
     * synchronized (this) { if (channel == null) channel =
     * FileChannelImpl.open(fd, true, false, this); return channel; } }
     */
