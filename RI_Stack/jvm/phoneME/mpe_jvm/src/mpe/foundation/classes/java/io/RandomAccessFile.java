...
public class RandomAccessFile implements DataOutput, DataInput
{
     ...
     * for the <a href="#mode"><tt>RandomAccessFile(File,String)</tt></a>
     * constructor.
     * 
     * <p>
    ...
    /**
     * Creates a random access file stream to read from, and optionally to write
     * to, the file specified by the {@link File} argument. A new
     ...
     * </blockquote>
     * 
     * If the file resides on a local storage device then when an invocation of
     * a method of this class returns it is guaranteed that all changes made to
    ...
    public RandomAccessFile(File file, String mode) throws FileNotFoundException
    {
        ...
        {
            if (rw)
                fd = new FileDescriptor(name, "rw");
            else
                fd = new FileDescriptor(name, "r");
        }
        catch (IOException e)
        {
     ...
     * 
     * <p>
     * The {@link java.nio.channels.FileChannel#position() </code>position
     * <code>} of the returned channel will always be equal to this object's
     * file-pointer offset as returned by the {@link #getFilePointer
     * getFilePointer} method. Changing this object's file-pointer offset,
     * whether explicitly or by reading or writing bytes, will change the
     * position of the channel, and vice versa. Changing the file's length via
     * this object will change the length seen via the file channel, and vice
     * versa.
     * 
     ...
     */
    /*
     * NOTE: No NIO in CDC public final FileChannel getChannel() { synchronized
     * (this) { if (channel == null) channel = FileChannelImpl.open(fd, true,
     * rw, this); return channel; } }
     */
     ...
     *            above
     */
    // private native void open(String name, int mode) throws
     ...
     * as the {@link InputStream#read(byte[], int, int)} method of
     ...
     * Although <code>RandomAccessFile</code> is not a subclass of
     * <code>InputStream</code>, this method behaves in the exactly the same way
     * as the {@link InputStream#read(byte[])} method of
     * <code>InputStream</code>.
     * 
     * @param b
     *            the buffer into which the data is read.
     ...
     * 
     * <pre>
     * ((long) b1 &lt;&lt; 56) + ((long) b2 &lt;&lt; 48) + ((long) b3 &lt;&lt; 40) + ((long) b4 &lt;&lt; 32) + ((long) b5 &lt;&lt; 24) + ((long) b6 &lt;&lt; 16)
     *         + ((long) b7 &lt;&lt; 8) + b8
     * </pre>
     * 
     * </blockquote>
